...
do
    LD_LIBRARY_PATH=../taco/build/lib/ python scripts/run.py ./a.out \
        --n_q 512 --n_k 512 --d_k 1024 --d_v 1024 --sparsity $sparsity --QFormat DD --KFormat DD --VFormat DD --sample 0 --convert 0 --runs 10 \
